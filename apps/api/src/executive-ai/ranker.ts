...
const intentSignals: Record<ExecutiveAiQueryPlan['intent'], string[]> = {
  ...
  DONOR_PROPOSAL: ['احتياج', 'مستفيد', 'أثر', 'برنامج', 'استدامة', 'تمويل'],
  MEETING_MINUTES: ['اجتماع', 'قرار', 'إجراء', 'مسؤول', 'موعد', 'متابعة'],
  EXECUTIVE_REPORT: ['أداء', 'مؤشر', 'نتيجة', 'مبادرة', 'موازنة', 'مخاطر'],
  DECISION: ['قرار', 'صلاحية', 'اعتماد', 'لائحة', 'مبرر', 'ضابط'],
  ACTION_PLAN: ['إجراء', 'مبادرة', 'مسؤول', 'موعد', 'مؤشر', 'متابعة'],
  GENERAL: [],
};
